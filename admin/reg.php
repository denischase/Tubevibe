...
if (isset($_POST['submit'])){
    ...
    if($run){
        echo "<script>alert('Data Has Been Inserted');window.location.href='adminlist.php';</script>";
    }
    else{
      echo "<script>alert('Not Inserted');window.location.href='adminlist.php';</script>";
    }
}
